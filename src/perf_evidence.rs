...
pub struct StageRecord {
    ...
    pub row_generation_ms: Option<f64>,
    pub worker_row_generation_ms: Option<f64>,
...
impl StageJournal {
    pub fn new(run_id: impl Into<String>) -> Self {
        Self {
            ...
            .map(|name| StageRecord {
                ...
                owned_bytes: None,
                retained_bytes: None,
                row_generation_ms: None,
                worker_row_generation_ms: None,
    ...
    pub fn json(&self) -> String {
        let stages = self.records.iter().map(|record| format!(
            "{{\"name\":\"{}\",\"status\":\"{}\",\"elapsed_ms\":{},\"submissions\":{},\"polls\":{},\"map_requests\":{},\"cache_hits\":{},\"cache_misses\":{},\"cache_capacity_bytes\":{},\"io_bytes\":{},\"owned_bytes\":{},\"retained_bytes\":{},\"row_generation_ms\":{},\"worker_row_generation_ms\":{},\"output_write_ms\":{},\"output_finish_ms\":{},\"reason\":{}}}",
            record.name,
            ...
            record.row_generation_ms.map_or_else(|| "\"NOT_RUN\"".into(), |value| value.to_string()),
            record.worker_row_generation_ms.map_or_else(|| "\"NOT_RUN\"".into(), |value| value.to_string()),
